...
const DocsContent = () => {
    return (
        <section className="w-full lg:w-11/12" id="products">
            ...
            <h1 id="cart" className="text-2xl md:text-3xl mb-4 mt-10 flex items-center text-left gap-3 font-medium cursor-pointer text-indigo-500">
            ...
            <h1 id="users" className="text-2xl md:text-3xl mb-4 mt-10 flex items-center text-left gap-3 font-medium cursor-pointer text-indigo-500">
